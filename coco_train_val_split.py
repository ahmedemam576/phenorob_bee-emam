...
# Paths
coco_json_path = "/scratch/s52melba/coco_sahi/coco_sahi.json"
images_dir = "/scratch/s52melba/coco_sahi/coco_sahi_images"
output_dir = "/scratch/s52melba/coco_sahi_train_val"
train_ratio = 0.85  # 80% train, 20% val
