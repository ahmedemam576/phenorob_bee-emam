...
train_img_dir = '/scratch/s52melba/coco_sahi_train_val/train'
val_img_dir = '/scratch/s52melba/coco_sahi_train_val/val'

train_json_file = '/scratch/s52melba/coco_sahi_train_val/train.json'
val_json_file = '/scratch/s52melba/coco_sahi_train_val/val.json'
...
data_yml_path = export_coco_as_yolov5(
  output_dir="/scratch/s52melba/dataset_yolo_sahi",
